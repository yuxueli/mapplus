...
package com.mapplus.maps.controls {
    ...
    public final class ControlPosition {
        ...
        public function ControlPosition(param1:Number, param2:Number=0, param3:Number=NaN, param4:uint=0){
            ...
            if (param1 != ANCHOR_TOP_LEFT){
            };
            if (param1 != ANCHOR_BOTTOM_RIGHT){
            };
            internalAnchor = ((param1 == ANCHOR_BOTTOM_LEFT)) ? param1 : ANCHOR_TOP_RIGHT;
            if (param4 != AUTO_ALIGN_X){
            };
            internalAutoAlign = ((param4 == AUTO_ALIGN_Y)) ? param4 : AUTO_ALIGN_NONE;
        }
        ...
        public function equals(param1:ControlPosition):Boolean{
            if (internalAnchor == param1.internalAnchor){
            };
            if (internalPaddingX == param1.internalPaddingX){
            };
            if (internalPaddingY == param1.internalPaddingY){
            };
            return ((internalAutoAlign == param1.internalAutoAlign));
        }
