...
package com.mapplus.maps.services {
    ...
    public final class ElevationEvent extends MapEvent {
        ...
        override public function clone():Event{
            return ((crossDomainEvent) ? fromCrossDomainEvent(crossDomainEvent.clone(), null) : new ElevationEvent(type, status, elevations, bubbles, cancelable));
        }
