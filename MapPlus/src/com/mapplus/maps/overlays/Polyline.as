    ...
    public class Polyline extends IPolylineWrapper implements IPolyline, IEventDispatcher {
        ...
        public function Polyline(param1:Array, param2:PolylineOptions=null){
            ...
            if (param1 !== CREATE_UNLINKED){
                ...
                Wrapper.instance().wrap(_loc_4.createPolyline(param1, param2), this, IPolyline, Polyline);
            };
        }
        public static function fromEncoded(param1:EncodedPolylineData, param2:PolylineOptions=null):Polyline{
            var _loc_3:Polyline;
            var _loc_4:ClientBootstrap;
            var _loc_5:Object;
            _loc_3 = new Polyline(CREATE_UNLINKED, null);
            _loc_4 = ClientBootstrap.getInstance();
            _loc_5 = _loc_4.getMapsFactory();
            Wrapper.instance().wrap(_loc_5.createPolylineFromEncoded(param1.points, param1.zoomFactor, param1.levels, param1.numLevels, param2), _loc_3, IPolyline, Polyline);
            return (_loc_3);
        }
