...
package com.mapplus.maps.overlays {
    ...
    public class PolygonStar extends IPolygonWrapper implements IPolygonShape, IEventDispatcher {

        private static var CREATE_UNLINKED:Array = [];

        public function PolygonStar(point:LatLng, r1:Number, r2:Number, points:Number, rotation:Number, opts:PolygonOptions=null){
            super();
            var _loc_3:ClientBootstrap;
            var _loc_4:IMapsFactory;
            _loc_3 = ClientBootstrap.getInstance();
            _loc_4 = _loc_3.getMapsFactory();
            Wrapper.instance().wrap(_loc_4.createPolygonStar(point, r1, r2, points, rotation, opts), this, IPolygonShape, PolygonShape);
        }
