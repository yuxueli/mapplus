...
package com.mapplus.maps.overlays {
    ...
    public class PolylineRegularPoly extends IPolylineWrapper implements IPolylineShape, IEventDispatcher {

        private static var CREATE_UNLINKED:Array = [];

        public function PolylineRegularPoly(point:LatLng, radius:Number, vertexCount:Number, rotation:Number, opts:PolylineOptions=null){
            super();
            var _loc_3:ClientBootstrap;
            var _loc_4:IMapsFactory;
            _loc_3 = ClientBootstrap.getInstance();
            _loc_4 = _loc_3.getMapsFactory();
            Wrapper.instance().wrap(_loc_4.createPolylineRegularPoly(point, radius, vertexCount, rotation, opts), this, IPolylineShape, PolylineShape);
        }
