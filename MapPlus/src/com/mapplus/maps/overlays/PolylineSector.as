...
package com.mapplus.maps.overlays {
    ...
    public class PolylineSector extends IPolylineWrapper implements IPolylineShape, IEventDispatcher {

        private static var CREATE_UNLINKED:Array = [];

        public function PolylineSector(point:LatLng, radius:Number, sDegree:Number, eDegree:Number, opts:PolylineOptions=null){
            super();
            var _loc_3:ClientBootstrap;
            var _loc_4:IMapsFactory;
            _loc_3 = ClientBootstrap.getInstance();
            _loc_4 = _loc_3.getMapsFactory();
            Wrapper.instance().wrap(_loc_4.createPolylineSector(point, radius, sDegree, eDegree, opts), this, IPolylineShape, PolylineShape);
        }
