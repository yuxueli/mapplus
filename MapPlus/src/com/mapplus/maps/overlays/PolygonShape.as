...
package com.mapplus.maps.overlays {
    ...
    public class PolygonShape extends IPolygonWrapper implements IPolygonShape, IEventDispatcher {
        ...
        public function PolygonShape(point:LatLng, r1:Number, r2:Number, r3:Number, r4:Number, rotation:Number, vertexCount:Number, opts:PolygonOptions=null, tilt:Boolean=false){
            ...
            Wrapper.instance().wrap(_loc_4.createPolygonShape(point, r1, r2, r3, r4, rotation, vertexCount, opts, tilt), this, IPolygonShape, PolygonShape);
        }
