...
package com.mapplus.maps.overlays {
    ...
    public class PolygonEllipse extends IPolygonWrapper implements IPolygonShape, IEventDispatcher {

        private static var CREATE_UNLINKED:Array = [];

        public function PolygonEllipse(point:LatLng, r1:Number, r2:Number, rotation:Number, opts:PolygonOptions=null){
            super();
            var _loc_3:ClientBootstrap;
            var _loc_4:IMapsFactory;
            _loc_3 = ClientBootstrap.getInstance();
            _loc_4 = _loc_3.getMapsFactory();
            Wrapper.instance().wrap(_loc_4.createPolygonEllipse(point, r1, r2, rotation, opts), this, IPolygonShape, PolygonShape);
        }
