...
package com.mapplus.maps.overlays {
    ...
    public class PolygonCircle extends IPolygonWrapper implements IPolygonShape, IEventDispatcher {

        private static var CREATE_UNLINKED:Array = [];

        public function PolygonCircle(point:LatLng, radius:Number, opts:PolygonOptions=null){
            super();
            var _loc_3:ClientBootstrap;
            var _loc_4:IMapsFactory;
            _loc_3 = ClientBootstrap.getInstance();
            _loc_4 = _loc_3.getMapsFactory();
            Wrapper.instance().wrap(_loc_4.createPolygonCircle(point, radius, opts), this, IPolygonShape, PolygonShape);
        }
