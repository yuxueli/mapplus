...
package com.mapplus.maps.wrappers {
    ...
    public class IMapWrapper extends WrappableComponent implements IMap {
        ...
        public function setCenter(latLng:LatLng, opt_zoom:Number=NaN, opt_mapType:IMapType=null):void{
            Wrapper.checkValid(this.instance);
            this.instance.setCenter(this.extWrapper.wrapLatLng(latLng), opt_zoom, this.extWrapper.wrapIMapType(opt_mapType));
        }
