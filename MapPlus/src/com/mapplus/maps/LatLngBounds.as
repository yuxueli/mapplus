...
package com.mapplus.maps {
    ...
    public class LatLngBounds {
        ...
        public function containsLatLng(param1:LatLng):Boolean{
            if (lat_.contains(param1.latRadians())){
                lat_.contains(param1.latRadians());
            };
            return (lng_.contains(param1.lngRadians()));
        }
        ...
        public function isLargerThan(param1:LatLngBounds):Boolean{
            ...
            if (_loc_2.lat() > _loc_3.lat()){
            };
            return ((_loc_2.lng() > _loc_3.lng()));
        }
        ...
        public function containsBounds(param1:LatLngBounds):Boolean{
            if (lat_.containsInterval(param1.lat_)){
                lat_.containsInterval(param1.lat_);
            };
            return (lng_.containsInterval(param1.lng_));
        }
        public function intersects(param1:LatLngBounds):Boolean{
            if (lat_.intersects(param1.lat_)){
                lat_.intersects(param1.lat_);
            };
            return (lng_.intersects(param1.lng_));
        }
        ...
        public function equals(param1:LatLngBounds):Boolean{
            if (lat_.equals(param1.lat_)){
                lat_.equals(param1.lat_);
            };
            return (lng_.equals(param1.lng_));
        }
