...
package com.mapplus.maps.core {
    ...
    public class ImageTransformRenderer {
        ...
        private function renderBitmapFragment(param1:Rectangle, param2:Point, param3:Point, param4:Point, param5:Point, param6:int):int{
            ...
            var _loc_45:Matrix;
            var _loc_46:Matrix;
            if (!(this.mayIntersectViewport(param2, param3, param4, param5))){
                return (0);
            };
            ...
            if (_loc_9){
                _loc_19 = this.transform(_loc_17, _loc_16);
                _loc_20 = this.transform(_loc_15, _loc_18);
                _loc_21 = this.transform(param1.right, _loc_18);
                _loc_22 = this.transform(_loc_17, param1.bottom);
                _loc_23 = this.transform(_loc_17, _loc_18);
                ...
                if (this.overSample){
                    ...
                    _loc_30 = this.transform(_loc_17, _loc_28);
                    _loc_31 = this.transform(_loc_26, _loc_18);
                    _loc_32 = this.transform(_loc_27, _loc_18);
                    _loc_33 = this.transform(_loc_17, _loc_29);
                ...
                if (_loc_25 < this.maxSingleQuadError){
                    _loc_9 = false;
                };
                if (_loc_25 < this.maxRecurseError){
                    _loc_10 = 0;
                };
            };
            if (_loc_9){
                _loc_35 = (Util.sqrDist(param2, param3) / Util.sqrDist(param2, param4));
                if (((this.splitUnidimensionallyIfAnisotropic) && ((_loc_35 > 8)))){
                    _loc_36 = new Rectangle(_loc_15, _loc_16, _loc_13, _loc_12);
                    _loc_37 = new Rectangle(_loc_17, _loc_16, _loc_13, _loc_12);
                    return ((this.renderBitmapFragment(_loc_36, param2, _loc_19, param4, _loc_22, _loc_10) + this.renderBitmapFragment(_loc_37, _loc_19, param3, _loc_22, param5, _loc_10)));
                };
                if (((this.splitUnidimensionallyIfAnisotropic) && ((_loc_35 < 0.125)))){
                    _loc_38 = new Rectangle(_loc_15, _loc_16, _loc_11, _loc_14);
                    _loc_39 = new Rectangle(_loc_15, _loc_18, _loc_11, _loc_14);
                    return ((this.renderBitmapFragment(_loc_38, param2, param3, _loc_20, _loc_21, _loc_10) + this.renderBitmapFragment(_loc_39, _loc_20, _loc_21, param4, param5, _loc_10)));
                };
                ...
                return ((((this.renderBitmapFragment(_loc_40, param2, _loc_19, _loc_20, _loc_23, _loc_10) + this.renderBitmapFragment(_loc_41, _loc_19, param3, _loc_23, _loc_21, _loc_10)) + this.renderBitmapFragment(_loc_42, _loc_20, _loc_23, param4, _loc_22, _loc_10)) + this.renderBitmapFragment(_loc_43, _loc_23, _loc_21, _loc_22, param5, _loc_10)));
            };
            ...
            Render.drawBitmapTriangle(this.graphics, this.pixels, _loc_45, param2, param3, param4);
            Render.drawBitmapTriangle(this.graphics, this.pixels, _loc_46, param3, param5, param4);
            return (2);
        }
