...
package com.mapplus.maps.controls {
    ...
    public class ScaleControl extends IWrappableSpriteWrapper implements IScaleControl {
        ...
        private function updateScale(param1:Boolean):void{
            ...
            _loc_8 = this.upperBarParameters.calculateDisplayInfo(_loc_7, this.getMaxWidth(), this.upperTextField);
            _loc_9 = 0;
            if (this.lowerBarParameters != null){
                _loc_9 = this.lowerBarParameters.calculateDisplayInfo(_loc_7, this.getMaxWidth(), this.lowerTextField);
            };
            ...
            this.drawControl(_loc_10, _loc_8, _loc_9, _loc_15);
        ...
        private function updateTextFormat(param1:TextField):void{
            ...
            _loc_3 = this.options.labelFormat;
        ...
        private function initControlWithMapInternal(param1:IControllableMap):void{
            ...
            if (param1){
                if (this.canvas == null){
                    ...
                    this.canvas.x = 0;
                    this.canvas.y = 0;
                    this.upperTextField = this.createControlTextField();
                    _loc_2.addChild(this.canvas, this.upperTextField);
                    this.lowerTextField = this.createControlTextField();
                    _loc_2.addChild(this.canvas, this.lowerTextField);
                };
                param1.addEventListener(MapEvent.MAPTYPE_CHANGED, this.onUpdateColours);
                param1.addEventListener(MapMoveEvent.MOVE_END, this.onUpdateScale);
                param1.addEventListener(MapZoomEvent.ZOOM_CHANGED, this.onUpdateScale);
                this.calculateControlParameters();
                this.updateColours();
            };
        }
        ...
        public function removeFromMap():void{
            if (this.map != null){
                this.map.removeEventListener(MapEvent.MAPTYPE_CHANGED, this.updateColours);
                this.map.removeEventListener(MapMoveEvent.MOVE_END, this.updateScale);
                this.map.removeEventListener(MapZoomEvent.ZOOM_CHANGED, this.updateScale);
            };
        }
        ...
        private function calculateControlParameters():void{
            ...
            var _loc_3:Boolean;
            var _loc_4:Boolean;
            _loc_1 = this.getBootstrapPrefersMetric();
            _loc_2 = this.getUnits();
            ...
            this.upperBarParameters = (_loc_3) ? this.createImperialParameters() : this.createMetricParameters();
            ...
            this.lowerBarParameters = (_loc_4) ? null : (_loc_3) ? this.createMetricParameters() : this.createImperialParameters();
            if (this.lowerTextField != null){
                this.lowerTextField.visible = !(_loc_4);
            };
        }
        ...
        private function updateColours():void{
            ...
            this.updateTextFormat(this.upperTextField);
            this.updateTextFormat(this.lowerTextField);
...
class ScaleControlParameters {
    ...
    public function calculateDisplayInfo(param1:Number, param2:Number, param3:TextField):Number{
        ...
        _loc_6 = this.round125((_loc_4 * param2));
        if (param3 != null){
