...
package com.mapplus.maps.controls {
    ...
    public class CopyrightView extends Sprite {
        ...
        override public function set width(param1:Number):void{
            this.copyrightField.width = param1;
        }
        private function setCopyright(param1:String):void{
            ...
            this.copyrightField.styleSheet = this.createCopyrightStyleSheet();
            this.copyrightField.htmlText = _loc_2;
        ...
        private function onEnterFrame(event:Event):void{
            ...
            _loc_2 = this.computeCopyrightText();
            this.setCopyright(unescape(_loc_2));
        }
        ...
        public function unload():void{
            while (this.recordList.length > 0) {
                this.removeRecord(this.recordList[0]);
            };
        }
