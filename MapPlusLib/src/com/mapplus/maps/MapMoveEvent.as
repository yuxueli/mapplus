...
package com.mapplus.maps {
    ...
    public class MapMoveEvent extends MapEvent {
        ...
        override public function clone():Event{
            return ((crossDomainEvent) ? fromCrossDomainEvent(crossDomainEvent.clone(), null) : new MapMoveEvent(type, this.latLng, bubbles, cancelable));
        }
        override public function toString():String{
            return ((((((((("[MapMoveEvent type=" + type) + " latLng=") + this.latLng) + " bubbles=") + bubbles) + " cancellable=") + cancelable) + "]"));
        }
