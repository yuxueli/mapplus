...
package com.mapplus.maps.services {
    ...
    public class MaxZoom extends WrappableEventDispatcher implements IMaxZoom {
        ...
        private static const VERSION_REGEXP:RegExp = /[&?\/](?:v|lyrs)=([^&]*)/;
        private static const ZOOM_REGEXP:RegExp = /"?zoom"?:\s*(\d+)/;
        ...
        protected function dispatchMaxZoomRequest(param1:LatLng, param2:int, param3:int, param4:int, param5:String):void{
            ...
            var zoom:* = param4;
            var version:* = param5;
            tileLayer = this.mapType.getTileLayers()[0];
        ...
        private function getTileVersion(param1:int, param2:int, param3:int):String{
            ...
            var _loc_5:String;
            var _loc_6:Array;
            _loc_4 = this.mapType.getTileLayers()[0];
        ...
        public function load(param1:LatLng, param2:Number=NaN):void{
            ...
            _loc_4 = Util.getTileCoordinates(param1, _loc_3, this.mapType.getProjection(), this.mapType.getTileSize());
            _loc_5 = this.getTileVersion(_loc_4.x, _loc_4.y, _loc_3);
            this.dispatchMaxZoomRequest(param1, _loc_4.x, _loc_4.y, _loc_3, _loc_5);
        }
