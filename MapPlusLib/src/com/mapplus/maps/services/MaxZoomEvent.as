...
package com.mapplus.maps.services {
    ...
    public final class MaxZoomEvent extends MapEvent {
        ...
        public function MaxZoomEvent(param1:String, param2:LatLng, param3:Number, param4:Boolean=false, param5:Boolean=false){
            ...
            this.eventLatLng = param2;
            this.eventZoom = param3;
        }
        ...
        override public function clone():Event{
            return ((crossDomainEvent) ? fromCrossDomainEvent(crossDomainEvent.clone(), null) : new MaxZoomEvent(type, this.latLng, this.zoom, bubbles, cancelable));
        }
        override public function toString():String{
            return ((((((((((("[MaxZoomEvent type=" + type) + " latLng=") + this.latLng) + " zoom=") + this.zoom) + " bubbles=") + bubbles) + " cancelable=") + cancelable) + "]"));
        }
