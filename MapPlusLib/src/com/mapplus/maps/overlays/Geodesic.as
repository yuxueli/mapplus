...
package com.mapplus.maps.overlays {
    ...
    public class Geodesic {
        ...
        public function Geodesic(param1:Function, param2:Number, param3:LatLngBounds=null){
            ...
            this.bounds = param3;
            if (param3){
                this.lngBounds = new S1Interval(Util.degreesToRadians(this.bounds.getWest()), Util.degreesToRadians(this.bounds.getEast()));
                _loc_4 = param1(this.bounds.getSouthWest());
                _loc_5 = param1(this.bounds.getNorthEast());
                this.latBounds = new R1Interval(_loc_5.y, _loc_4.y);
            };
        }
        ...
        static function bifurcate(param1:Array, param2:Array, param3:Array, param4:Function, param5:int, param6:int):int{
            var _loc_7:int;
            var _loc_8:Array;
            var _loc_9:Array;
            var _loc_10:Array;
        ...
        static function arcToLatExtremum_(param1:LatLng, param2:LatLng):LatLng{
            var _loc_3:Array;
            var _loc_4:Array;
            var _loc_5:Array;
            var _loc_6:Array;
        ...
        public function arcToGeodesicImpl(param1:Array, param2:Array, param3:Array, param4:Function, param5:int, param6:int, param7:int, param8:int=-1):Array{
            ...
            if (this.lngBounds){
                ...
                if (!(this.lngBounds.intersects(_loc_22))){
                    return ([_loc_9, _loc_10]);
                };
            };
            ...
            if (this.latBounds){
                ...
                if (!(this.latBounds.intersects(_loc_23))){
                    return ([_loc_9, _loc_10]);
                };
            };
            if ((((((((((((Math.abs((_loc_14.x - _loc_18.x)) > this.tolerance)) || ((Math.abs((_loc_14.y - _loc_18.y)) > this.tolerance)))) || ((Math.abs((_loc_15.x - _loc_17.x)) > this.tolerance)))) || ((Math.abs((_loc_15.y - _loc_17.y)) > this.tolerance)))) || ((Math.abs((_loc_16.x - _loc_19.x)) > this.tolerance)))) || ((Math.abs((_loc_16.y - _loc_19.y)) > this.tolerance)))){
                _loc_24 = this.arcToGeodesicImpl(param1, param2, param3, param4, param5, _loc_11, (param7 + 1), _loc_12);
                _loc_25 = this.arcToGeodesicImpl(param1, param2, param3, param4, _loc_11, param6, (param7 + 1), _loc_13);
                _loc_24.pop();
